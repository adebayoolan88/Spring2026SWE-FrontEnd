...
function SearchBar({ value, onChange }) {
  return (
    ...
    <div className="flex w-full flex-col gap-3 rounded-[28px] border border-slate-200/80 bg-white p-3 shadow-[0_12px_30px_rgba(15,23,42,0.12)] md:flex-row md:items-center">
